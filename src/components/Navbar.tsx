...
import LogoImage from '../assets/icons/havel.svg';
        ...
        <div className="container bg-black">
          <div className="py-4 flex items-center justify-between">
            <div className="relative">
              ...
              <LogoImage className="h-12 w-12 relative mt-1 mr-1" />
            </div>
            ...
            <nav className='text-white gap-6 items-center hidden sm:flex'>
              ...
              <button className='bg-white py-2 px-4 rounded-lg text-black' onClick={() => window.open("https://discord.gg/Sz7YbUcD2X", "_blank")}>Join Discord</button>
            </nav>
